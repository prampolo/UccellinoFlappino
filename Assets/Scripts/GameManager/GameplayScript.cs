...
public class GameplayScript : MonoBehaviour {
    ...
    public GameObject enemySpawner, healthSpawner, coinSpawner; 
    ...
    public void RestartGame() {
        ...
        enemySpawner.GetComponent<SpawnEnemy>().Reset();
        healthSpawner.GetComponent<CoinSpawn>().Reset();
        coinSpawner.GetComponent<HealthSpawn>().Reset();
